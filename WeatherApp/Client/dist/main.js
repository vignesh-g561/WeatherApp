...
var cityRender = cnames.map(function (city) {
  var cities=[];
     ...
     if(cities.length > 0){
           ...
           React.createElement("div", {className: "row panel "}, 
             React.createElement("div", {className: "col-md-8"}, 
               React.createElement("div", {style: {"float":"left"}}, 
                 React.createElement(Link, {to: "/DataComponent/"+city.name}, city.name), 
                 React.createElement("p", null, " Min Temperature ", cities[0].main.temp_min, " Max Temperature ", cities[0].main.temp_max, " "), 
                 React.createElement("p", null, " Wind : ", cities[0].wind.speed)
               ), 
                 React.createElement("button", {className: "btn btn-primary", key: city, style: {"float":"right"}, onClick: (cities)=>ref(city.name)}, "Refresh")
             )
           )
         )
       );
       ...
       return(
         ...
         React.createElement("div", {className: "row panel "}, 
           React.createElement("div", {className: "col-md-8"}, 
             React.createElement("h3", {style: {"float":"left"}}, city), 
             React.createElement("button", {className: "btn btn-primary", key: city, style: {"float":"right"}, onClick: (cities)=>ref(city.name)}, "Refresh")
             )
           )
         )
  ...
  return (
    React.createElement("span", null, cityRender)
  );
}
});
...
var WeatherReport = React.createClass({displayName: "WeatherReport",
  getInitialState : function() {
  ...
  render:function(){
    ...
    return (
      React.createElement("div", null, 
        React.createElement(WeatherData, {cities: data, dbData: tData, mydata: this.addData}), 
          ...
          React.createElement("div", {className: "modal-dialog", role: "document"}, 
            React.createElement("div", {className: "modal-content"}, 
              React.createElement("div", {className: "modal-header"}, 
                ...
                React.createElement("h4", {className: "modal-title", id: "myModalLabel"}, city.name)
              ), 
              React.createElement("div", {className: "modal-body"}, 
              React.createElement("table", {className: "table"}, 
              React.createElement("tr", null, 
                React.createElement("td", null, "COD"), 
                React.createElement("td", null, city.cod)
              )
            )
              )
            )
...
},{"./WeatherData":202,"react":199}],204:[function(require,module,exports){
var React = require('react');
var Router = require('react-router');
...
React.createElement(Route, null, 
  ...
  React.createElement(DefaultRoute, {handler: WeatherReport, name: "WeatherReport"})
), 
React.createElement(Route, {handler: DataComponent, name: "DataComponent", path: "/DataComponent/id"})
)
);
},{"./Components/DataComponent":200,"./Components/Master":201,"./Components/WeatherReport":203,"react":199,"react-router":35}]},{},[204]);
